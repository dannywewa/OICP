...
class Property:
    ...
    def __init__(self, thing: webthing.thing.Thing, name: str, value: Any, metadata: Dict | None = None):
        '''
        ...
        metadata -- property metadata, i.e., type, description, unit, etc., as a dict
        '''
        self.thing = thing
        self.name = name
        self.value = value
        ...
        # Add the property change observer to notify the Thing about a property change
